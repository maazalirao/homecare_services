          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@specialtouchhomecare.com" className="text-white hover:text-[#58b4db] transition-colors">info@specialtouchhomecare.com</a>
              </li>
            </ul>
          </div>
        </div>

        <div className="border-t border-[#194168] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
