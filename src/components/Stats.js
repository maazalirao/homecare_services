      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center mb-8 md:mb-12">
          <div className="bg-primary-500 text-white py-3 px-4 mb-6 rounded-lg md:rounded-xl mx-auto max-w-max">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white">Trusted by Many, Personal to Each</h2>
          </div>
          <p className="text-neutral-900 text-base md:text-lg px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in flex flex-col items-center">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-secondary-50 flex items-center justify-center text-secondary-500 mb-3 md:mb-4">
            ...
            <p className="text-base md:text-lg font-medium text-primary-500 mb-1">Happy Clients</p>
            <p className="text-sm text-neutral-900">served across New York</p>
          </div>
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in flex flex-col items-center">
            ...
            <p className="text-base md:text-lg font-medium text-primary-500 mb-1">Star Rating</p>
            <p className="text-sm text-neutral-900">by thousands of reviews</p>
          </div>
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in flex flex-col items-center">
            ...
            <p className="text-base md:text-lg font-medium text-primary-500 mb-1">Years Experience</p>
            <p className="text-sm text-neutral-900">of quality home care</p>
          </div>
        </div>
      </div>
    </section>
