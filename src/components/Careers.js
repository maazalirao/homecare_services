...
const JobCard = ({ title, type, location, description }) => {
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-lg border border-gray-100 hover:border-[#58b4db]/20 transition-all duration-300 h-full flex flex-col animate-fade-in p-6 relative overflow-hidden group">
      <div className="absolute inset-0 bg-gradient-to-tr from-[#0d2c4b]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div>
          <h3 className="text-xl font-bold text-[#0d2c4b] group-hover:text-[#58b4db] transition-colors">{title}</h3>
        ...
        <span className="text-xs font-medium bg-[#58b4db] text-white py-1 px-3 rounded-full shadow-sm">New</span>
      </div>
      <p className="text-neutral-700 mb-6 flex-grow relative z-10">{description}</p>
      <Link 
        href="/careers" 
        className="inline-flex items-center text-[#0d2c4b] font-medium hover:text-[#58b4db] transition-colors mt-auto relative z-10 group"
      >
        Apply Now
        <svg 
      ...
      <div className="container-custom">
          ...
          <div className={`order-2 lg:order-1 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            <div className="relative w-full h-[300px] md:h-[400px] lg:h-[500px] rounded-xl overflow-hidden shadow-lg group">
              <Image
                ...
                quality={95}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0d2c4b]/80 via-[#0d2c4b]/50 to-transparent"></div>
            </div>
          </div>
          
          <div className={`order-1 lg:order-2 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{animationDelay: "0.2s"}}>
            <div className="relative inline-block mb-4">
              <div className="absolute inset-0 bg-[#58b4db] rounded-tl-lg rounded-br-lg transform -rotate-1 scale-105 opacity-20"></div>
              <div className="bg-[#58b4db] text-white px-6 py-4 rounded-tl-lg rounded-br-lg shadow-md">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="w-14 h-14 rounded-full bg-[#58b4db] flex items-center justify-center text-white mr-4 flex-shrink-0 shadow-md">
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-[#0d2c4b] mb-1">Competitive Pay</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#0d2c4b] mb-1">Flexible Scheduling</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#0d2c4b] mb-1">Career Growth</h3>
            ...
            <div className="mt-10">
              <Link 
                href="/careers" 
                className="inline-flex items-center justify-center px-6 py-3 bg-[#0d2c4b] hover:bg-[#194168] text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1"
              >
                View All Openings
        ...
        <div className={`mt-16 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{animationDelay: "0.4s"}}>
          <div className="text-center max-w-3xl mx-auto mb-12">
            <div className="relative inline-block mb-4">
              <div className="absolute inset-0 bg-[#0d2c4b] rounded-tl-lg rounded-br-lg transform rotate-1 scale-105 opacity-20"></div>
              <div className="bg-[#0d2c4b] text-white px-6 py-3 rounded-tl-lg rounded-br-lg shadow-md">
