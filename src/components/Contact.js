    ...
    <section id="contact" className="section bg-white">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="heading-2 text-neutral-800 mb-4">Get in Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="card animate-fade-in">
            {submitSuccess ? (
              <div className="text-center py-8">
                ...
                <h3 className="heading-3 text-neutral-800 mb-3">Message Sent!</h3>
              ...
              <>
                <h3 className="heading-3 text-neutral-800 mb-6">Send Us a Message</h3>
          ...
          <div className="space-y-8">
            <div className="card animate-fade-in">
              <h3 className="heading-3 text-neutral-800 mb-6">Contact Information</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="min-w-[40px] h-10 rounded-full bg-primary-50 flex items-center justify-center text-primary-500 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">123 Broadway, Suite 456, New York, NY 10001</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="min-w-[40px] h-10 rounded-full bg-primary-50 flex items-center justify-center text-primary-500 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">
                      <a href="tel:+12125551234" className="hover:text-primary-500 transition-colors">(212) 555-1234</a>
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">
                      <a href="mailto:info@specialtouchhomecare.com" className="hover:text-primary-500 transition-colors">info@specialtouchhomecare.com</a>
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
